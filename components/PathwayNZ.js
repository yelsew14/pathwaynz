        ...
        {page === 'ielts' && (
          <div className="fi" style={{ paddingTop: 40 }}>
            ...
            <Sec title="Band Score Guide for NZ Visas">
              <div className="sx">
                <table style={{ width:'100%', borderCollapse:'collapse', minWidth: 520 }}>
                  <thead><tr style={{ background: COLORS.navy }}>
                    {['IELTS Band','PTE Score','Level','NZ Visa Eligibility'].map(h => <th key={h} className="it" style={{ padding:'11px 16px', color: COLORS.white, textAlign:'left', fontSize:13, fontWeight:600 }}>{h}</th>)}
                  </tr></thead>
                  <tbody>
                    {BAND_GUIDE.map((b,i) => (
                      <tr key={i} style={{ background: i%2===0 ? COLORS.cardBg : '#fdf6ee', borderBottom:`1px solid ${COLORS.border}` }}>
                        ...
                        <td className="it" style={{ padding:'11px 16px', fontSize:13, color: COLORS.muted, fontWeight:600 }}>{b.pte}</td>
              ...
              <p className="it" style={{ fontSize:11.5, color:COLORS.dimmed, marginTop:8 }}>* PTE scores are approximate equivalents. Always confirm with Immigration NZ for your specific visa type.</p>
            </Sec>
